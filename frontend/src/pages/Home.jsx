...
const Home = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-73px)] bg-slate-950 text-slate-100 flex flex-col justify-center items-center px-6 py-16">
      <div className="max-w-5xl w-full text-left sm:text-center space-y-8">
        ...
        {error && (
          <div className="max-w-md mx-auto bg-rose-500/10 border border-rose-500/30 text-rose-400 p-4 rounded-sm text-sm font-mono">
            {error}
          </div>
        )}
          ...
          {user ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl text-left">
              ...
              <div className="bg-slate-900/60 border border-slate-800 p-6 sm:p-8 rounded-sm">
                ...
                <h3 className="font-bold text-xl text-white mb-2">Join Room</h3>
                <p className="text-slate-400 text-xs mb-6">
                ...
                <form onSubmit={handleJoinRoom} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-white hover:bg-slate-200 text-slate-950 font-mono font-bold text-xs uppercase tracking-widest rounded-sm transition duration-150"
                  >
                    Connect Channel
                  </button>
                </form>
