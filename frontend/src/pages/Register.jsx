      ...
      <div className="border border-slate-800 bg-slate-900/40 p-6 sm:p-8 rounded-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-white font-mono font-bold text-xs uppercase tracking-widest rounded-sm transition duration-150 active:scale-[0.99]"
            >
              Register Identity
            </button>
          </div>
