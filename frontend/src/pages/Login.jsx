      ...
      <div className="border border-slate-800 bg-slate-900/40 p-8 sm:p-10 rounded-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full py-3.5 bg-white hover:bg-slate-200 text-slate-950 font-mono font-bold text-sm uppercase tracking-widest rounded-sm transition duration-150 active:scale-[0.99]"
            >
              Authenticate
            </button>
          </div>
